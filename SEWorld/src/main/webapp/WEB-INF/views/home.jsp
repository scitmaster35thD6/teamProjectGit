...
<body>
	<div id="map"></div>
	<span id="menu"><img src="resources/image/menu/menu4.png"
		width="40px;" height="40px;" align="top" /></span>
	<span id="login"><img src="resources/image/login/login17.png"
		width="60px;" height="60px;" align="top" /></span>
