...
<!-- ============================================================== -->
    ...
    <div class="container">
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="menu-has-children">
            <a href="#portfolio">User's Voice</a>
            <ul>
    ...
    <div class="card">
      <div class="card-body">
        <div class="m-t-30" style="text-align:center">
          <div class="row">
            <div class="col-sm-12 col-lg-6"><h4 class="card-title-left m-t-10">${articleDetail.title}</h4></div><!-- 타이틀 콜롬 -->
            <div class="col-sm-12 col-lg-6">
              <img src="resources/assets/images/users/5.jpg" class="rounded-circle" width="60" />
      ...
      <div class="card-body">
        ...
        <c:if test="${not empty articleAttachement}">
          &nbsp;<a href="downloadFile?boardId=${articleAttachement.boardId}">${articleAttachement.ogFilename}</a>
        </c:if>
      </div>
      <c:if test="${articleDetail.memberId == sessionScope.loginId}">
        <div class="ml-auto d-flex no-block align-items-center">
          <a href="updateArticle?boardId=${articleDetail.boardId}"><i class="far fa-sun"></i>&nbsp;수정</a>&nbsp;&nbsp;
          <a href="javascript:areYouSure('${articleDetail.boardId}')"><i class="far fa-trash-alt"></i>&nbsp;삭제&nbsp;&nbsp;&nbsp;&nbsp;</a>
        </div>
        <p></p>
      </c:if>
    </div>
            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-lg-9">
                  ...
                  <textarea class="form-control rounded-0" id="comentContent" rows="5" name="content"></textarea>
                  <hr>
                  <button type="button" class="btn btn-success waves-effect text-left float-right" id="commentSave">Save</button>
                </div>
              </div>
              <!-- row -->
            </div>
                  ...
                  <div class="d-flex flex-row comment-row m-t-0">
                    <div class="comment-text w-100">
                      ...
                      <div class="comment-footer">
                        <i class="fas fa-heart" style="color: #f77497;"></i>15 <span class="text-muted float-right">${replys.updatedDate}</span>
                      ...
                      <div class="card">
                        <div class="card-body">
                          <div class="d-flex no-block align-items-center m-b-15">
                            ...
                            <div class="ml-auto">
                              <a href="javascript:void(0)" class="link"><i class="ti-comments"></i>&nbsp;&nbsp;${replyListCount[RelatedArticles[2].boardId]} Comments</a>
                            </div>
                          </div>
                          <h3 class="font-normal">${RelatedArticles[2].title}</h3>
                          <p class="m-b-0 m-t-10">${fn:substring(RelatedArticles[2].content, 0, 10)}</p>
                          <button class="btn btn-success btn-rounded waves-effect waves-light m-t-20" onclick="location.href='readArticle?boardId=${RelatedArticles[2].boardId}'">Read more</button>
                        </div>
                      </div>
                    </div>
                  </c:if>
                      ...
                      <div class="card">
                        <div class="card-body">
                          <div class="d-flex no-block align-items-center m-b-15">
                            ...
                            <div class="ml-auto">
                              <a href="javascript:void(0)" class="link"><i class="ti-comments"></i>&nbsp;&nbsp;${replyListCount[RelatedArticles[1].boardId]} Comments</a>
                            </div>
                          </div>
                          <h3 class="font-normal">${RelatedArticles[1].title}</h3>
                          <p class="m-b-0 m-t-10">${fn:substring(RelatedArticles[1].content, 0, 10)}</p>
                          <button class="btn btn-success btn-rounded waves-effect waves-light m-t-20" onclick="location.href='readArticle?boardId=${RelatedArticles[1].boardId}'">Read more</button>
                        </div>
                      </div>
                    </div>
                  </c:if>
                      ...
                      <div class="card">
                        <div class="card-body">
                          <div class="d-flex no-block align-items-center m-b-15">
                            ...
                            <div class="ml-auto">
                              <a href="javascript:void(0)" class="link"><i class="ti-comments"></i>&nbsp;&nbsp;${replyListCount[RelatedArticles[0].boardId]} Comments</a>
                            </div>
                          </div>
                          <h3 class="font-normal">${RelatedArticles[0].title}</h3>
                          <p class="m-b-0 m-t-10">${fn:substring(RelatedArticles[0].content, 0, 10)}</p>
                          <button class="btn btn-success btn-rounded waves-effect waves-light m-t-20" onclick="location.href='readArticle?boardId=${RelatedArticles[0].boardId}'">Read more</button>
                        </div>
                      </div>
                    </div>
                  </c:if>
  ...
  <script>
    ...
    function printFollowshipButton(resp) {
      var memberId = $('.card-subtitle').html();
      var result = '';
      result += '<a class="dropdown-item" href="p?mid=' + memberId + '&ptype=a"><i class="icon-user"></i>&nbsp;프로필 보기</a>';
