...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDf0YT_ifom64iJnlKsQ7XYfONTzQcNGvg&callback=initMap"></script>
...
<script>
  ...
  function printExbtDetail(resp) {
    ...
    if (resp.wishing == null || resp.wishing == 'N') {
      result += '<input class="wish_n" type="button" value="가고싶어요" />';
    } else {
      result += '<input class="wish_y" type="button" value="가고싶어요" style="background-color:red;" />';
    }
    if (resp.rating == null) {
      result += '<span class="star-input">';
      result += '<input id="star-delete" type="button" value="-" />';
      result += '<span class="input">';
      result += '<input type="radio" name="star-input" id="p1" value="1"><label for="p1">0.5</label>';
      result += '<input type="radio" name="star-input" id="p2" value="2"><label for="p2">1.0</label>';
      result += '<input type="radio" name="star-input" id="p3" value="3"><label for="p3">1.5</label>';
      result += '<input type="radio" name="star-input" id="p4" value="4"><label for="p4">2.0</label>';
      result += '<input type="radio" name="star-input" id="p5" value="5"><label for="p5">2.5</label>';
      result += '<input type="radio" name="star-input" id="p6" value="6"><label for="p6">3.0</label>';
      result += '<input type="radio" name="star-input" id="p7" value="7"><label for="p7">3.5</label>';
      result += '<input type="radio" name="star-input" id="p8" value="8"><label for="p8">4.0</label>';
      result += '<input type="radio" name="star-input" id="p9" value="9"><label for="p9">4.5</label>';
      result += '<input type="radio" name="star-input" id="p10" value="10"><label for="p10">5.0</label>';
      result += '</span>';
      result += '</span>';
    } else {
      result += '<span class="star-input">';
      result += '<input id="star-delete" type="button" value="-" />';
      result += '<span class="input">'
      if (resp.rating == 0.5) result += '<input type="radio" name="star-input" id="p1" value="1" checked><label for="p1">0.5</label>';
      else result += '<input type="radio" name="star-input" id="p1" value="1"><label for="p1">0.5</label>';
      if (resp.rating == 1.0) result += '<input type="radio" name="star-input" id="p2" value="2" checked><label for="p2">1.0</label>';
      else result += '<input type="radio" name="star-input" id="p2" value="2"><label for="p2">1.0</label>';
      if (resp.rating == 1.5) result += '<input type="radio" name="star-input" id="p3" value="3" checked><label for="p3">1.5</label>';
      else result += '<input type="radio" name="star-input" id="p3" value="3"><label for="p3">1.5</label>';
      if (resp.rating == 2.0) result += '<input type="radio" name="star-input" id="p4" value="4" checked><label for="p4">2.0</label>';
      else result += '<input type="radio" name="star-input" id="p4" value="4"><label for="p4">2.0</label>';
      if (resp.rating == 2.5) result += '<input type="radio" name="star-input" id="p5" value="5" checked><label for="p5">2.5</label>';
      else result += '<input type="radio" name="star-input" id="p5" value="5"><label for="p5">2.5</label>';
      if (resp.rating == 3.0) result += '<input type="radio" name="star-input" id="p6" value="6" checked><label for="p6">3.0</label>';
      else result += '<input type="radio" name="star-input" id="p6" value="6"><label for="p6">3.0</label>';
      if (resp.rating == 3.5) result += '<input type="radio" name="star-input" id="p7" value="7" checked><label for="p7">3.5</label>';
      else result += '<input type="radio" name="star-input" id="p7" value="7"><label for="p7">3.5</label>';
      if (resp.rating == 4.0) result += '<input type="radio" name="star-input" id="p8" value="8" checked><label for="p8">4.0</label>';
      else result += '<input type="radio" name="star-input" id="p8" value="8"><label for="p8">4.0</label>';
      if (resp.rating == 4.5) result += '<input type="radio" name="star-input" id="p9" value="9" checked><label for="p9">4.5</label>';
      else result += '<input type="radio" name="star-input" id="p9" value="9"><label for="p9">4.5</label>';
      if (resp.rating == 5.0) result += '<input type="radio" name="star-input" id="p10" value="10" checked><label for="p10">5.0</label>';
      else result += '<input type="radio" name="star-input" id="p10" value="10"><label for="p10">5.0</label>';
      result += '</span>';
      result += '</span>';
    }
    $('#wrc').html(result);
...
<section>
	<div id="wrapper">
		...
		<div class="col-md-6 buttonrow"></div>
...
<!--     <div class="col-md-6 commentrow">
		<div class="input"><br/>
			...
			<input class="replytext" type="text" placeholder="내용" onkeypress="if(event.keyCode==13) {replyInsert(); return false;}">
